...
// const navigation = useNavigation()
    ...
    useEffect(() => {
        ...
        const styles = StyleSheet.create({
            ...
            dataContainer: { margin: 8, borderColor: '#96ceb4', borderWidth: 2, borderRadius: 10, padding: 16, flexDirection:'row'},
            title: {fontSize: 18, fontWeight:'bold'},
            movieDescriptionContainer: { flex: 1, justifyContent:'center', marginLeft:8},
            yearContainer: {marginBottom: 8, marginTop: 8},
            mainCategoryContainer: {marginTop: 8, marginLeft: 8, marginRight: 8, flexDirection:'rows'},
